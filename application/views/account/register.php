...
<head>
  ...
  <title>Register an account - InvestBook</title>
    ...
    <div class="app-content">
      ...
      <form id="registerForm" class="form-signin">
        ...
        <div class="px-2">
          ...
          <div class="form-label-group">
            <input type="text" id="loginUsername" class="form-control" placeholder="Login Username"
              maxlength="60" required>
            <label for="loginUsername">Login Username</label>
            <div class="invalid-feedback text-white" style="opacity: 0.5">
            ...
            <span id="usernameChecking" class="spinner spinner-border spinner-border-sm text-warning d-none"
              style="position: absolute; top: 17px; right: 10px;"></span>
          </div>

          <div class="form-label-group">
            <input type="password" id="loginPassword" class="form-control" placeholder="Login Password"
              maxlength="60" required>
          ...
          <button id="submitBtn" type="button" class="btn btn-lg btn-warning btn-block">
            Register
          </button>

          <a href="<?= site_url('account/login'); ?>" class="btn btn-lg btn-link btn-block text-white"
            style="opacity: 0.75">
  ...
  <script>
    $(function() {
      ...
      $('#submitBtn').on('click', function() {
        var invalid = false;
        var inputElems = $('#registerForm').find('input');
        ...
        if (invalid) {
          alert('Please complete the register form before submit.')
          return;
        }
